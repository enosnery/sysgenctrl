...
if ($senha !== null) {
  $produtos = "INSERT INTO usuario (nome, email, senha, is_usuario_representante, login) VALUES  ($1, $2, $3, true, $4);";
  $resultado = pg_prepare($conexao, "query_insert_rep", $produtos);
  $resultado = pg_execute($conexao, "query_insert_rep", array($nome, $email, $senha, $login));
