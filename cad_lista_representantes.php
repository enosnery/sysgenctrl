...
$produtos = "SELECT idusuario, nome, email  FROM usuario WHERE is_usuario_representante = true ORDER BY idusuario;";
...
echo "<tr>";
  ...
  echo "<td id='cadRepDesc'>";
	...
	echo "<span class='cadRepIcon glyphicon glyphicon-pencil' onclick='goToDetail($i)'>";
	echo "</span>";
	echo "</td>";
	echo "<td id='cadProdButton'>";
	echo "<span class='cadRepIcon glyphicon glyphicon-trash' onclick='removeItem($i)'>";
	echo "</span>";
	echo "</td>";
	echo "</tr>";
	echo "</table>";
