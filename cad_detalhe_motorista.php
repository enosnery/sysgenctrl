...
$produtos = "SELECT idusuario, nome, email, codigo_motorista FROM usuario WHERE idusuario = $index;";
...
$i = 0 ;
  ...
  echo "<label for='senha'>Código</label>";
  echo "<input id='codigo' name='codigo' class='prodDetailInput centAlign' value='$codigo' />";
