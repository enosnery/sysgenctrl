         ...
         <div id="appBody">
           <div class="list-group">
             <div class="menuHeader list-group-item list-group-item-action" >
               ...
               <button type="button" style="font-size:0.9em">Inserir Novo Representante</button>
               <img class="logoadm img-responsive" src="<?php include('get_logo.php');?>"/>
             </div>
          </div>

            <form action="insere_representante.php" method="post" enctype="multipart/form-data">
