...
if($isestoque > 0){
  ...
  $resultado = pg_execute($conexao, "query_insert_user1", array($quantidade, $idproduto, $idrepresentante));
...
if ($num_linhas > 0)
    ...
    $resultado1 = pg_execute($conexao, "query_insert_user3", array($quantidade, $idrepresentante, $idproduto));
    $update4 = "UPDATE estoque_motorista SET quantidade_atual = quantidade_atual + $1  WHERE idmotorista = $2 AND id_produto = $3;";
