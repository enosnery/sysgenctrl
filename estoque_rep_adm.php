...
<body>
         <div id="appBody">
           <div class="list-group">
             <div class="menuHeader list-group-item list-group-item-action" >
               ...
               <button type="button" style="font-size:0.9em">Estoque Representantes</button>
           ...
           <div id="listaCadastro" class="listaCadastro">
             <?php include('estoque_lista_representantes.php')?>
           </div>
   </div>
  ...
  function goToEstoqueRep(index) {
    $.post("estoque_redirect.php", {index: index}, function (result){ window.location="estoque_rep_detail.php";});
  }
